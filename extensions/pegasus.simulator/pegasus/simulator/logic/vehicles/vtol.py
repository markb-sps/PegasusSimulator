...
class VTOL(Vehicle):
    ...
    def update(self, dt: float):
        ...
        rotor_forces, pusher_force, aileron_forces, elevator_force, rudder_force, rolling_moment = self._thrusters.update(self._state, dt)
    ...
    def force_and_torques_to_velocities(self, force: float, torque: np.ndarray):
        ...
        allocation_matrix[3, :4] = [self._thrusters._rolling_moment_coefficient[i] * self._thrusters._rot_dir[i] for i in range(4)]
